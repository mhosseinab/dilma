    ...
    <Container>
      <div className="content">
        <div className="title">
          ...
          <p>
            در دنیای امروز و با گسترش ارتباطات، تماشای ویدئو و گوش دادن به
            پادکست با زبان‌های مختلف، به یکی از کارهای روزانه و مورد علاقه مردم
            تبدیل شده است و نیاز به ترجمه این ویدئوها بیش از پیش احساس می‌شود.
            مترجمین ما در دیلما، فیلم و سریال، پادکست و انواع فایل‌های صوتی را
            با بهترین کیفیت و در فرمت‌های متنوع ترجمه می‌کنند تا بتوانید به
            راحتی سریال مورد علاقه خود را تماشا کنید.
          </p>
        </div>
        <div className="movie">
      ...
      <img className="icon" src="img/translate/Frame.png" alt="" />
    </Container>
  );
};
