...
import TranslateRewardsMobile from "./TranslateRewardsMobile";

const TranslateRewards = () => {
  return (
    <Container>
      <div className="line wide">
        <div className="chart item-1">
          <div className="item">
            <img
              src="/img/translate/officialTranslate/rewards/Vector-3.svg"
              alt=""
            />
          </div>
          <h4>+2500</h4>
        ...
        <div className="chart item-2">
          <div className="item">
            <img
              src="/img/translate/officialTranslate/rewards/Vector.svg"
              alt=""
            />
          </div>
          <h4>+2500</h4>
        ...
        <div className="chart  item-3">
          <div className="item">
            <img
              src="/img/translate/officialTranslate/rewards/Vector-2.svg"
              alt=""
            />
          </div>
          <h4>+2500</h4>
        ...
        <div className="chart  item-3">
          <div className="item">
            <img
              src="/img/translate/officialTranslate/rewards/Vector-1.svg"
              alt=""
            />
          </div>
          <h4>+2500</h4>
        ...
        <div className="trophy">
          <div className="icon">
            <img
              src="/img/translate/officialTranslate/rewards/trophy.png"
              alt=""
            />
          </div>
        </div>
...
export default TranslateRewards;
